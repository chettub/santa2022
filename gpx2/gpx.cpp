...
int d4_vertices_id(vector<int>& solution_blue, vector<int>& solution_red, int* d4_vertices, int* common_edges_blue, int* common_edges_red) {
...
void insert_ghost(vector<int> solution, int* solution_p2, int* d4_vertices, int* label_list_inv) {
    int i, j, aux;
...
void tourTable_fill(int** Tour_table, int* d2_vertices, int* solution_blue_p2, int* solution_red_p2, vector<int>& solution_red, int* label_list, int* label_list_inv, int* common_edges_blue_p2, int* common_edges_red_p2, int n_new) {
...
void tourTable(int* solution_blue_p2, int* solution_red_p2, vector<int> solution_red, int* label_list, int* label_list_inv, int* vector_comp, int n_new, int* common_edges_blue_p2, int* common_edges_red_p2) {
