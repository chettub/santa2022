...
public:
    ...
    int128 off_gen(int* sol_blue, int* sol_red, vector<int>& offspring, int* label_list);
    void print(void);
...
int128 candidates::off_gen(int* sol_blue, int* sol_red, vector<int>& offspring, int* label_list) {
    int i, i_l, i_h, k, aux, aux2, *select_cand, select_rest, *offspring_p2, *sol_blue_index, *sol_red_index, v_aux;
    int128 blue_fitness_rest, red_fitness_rest, fitness;
